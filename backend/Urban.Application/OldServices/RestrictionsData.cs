    ...
    public static class RestrictionsData
    {
        ...
        public static List<Restriction> ReadGeojsonWithPolygonsAndPoints(string jsonContent, string restrictionType)
        {
            ...
            foreach (var feature in features.EnumerateArray())
            {
                ...
                {
                    Console.WriteLine(geomType); // We have in buildings "MultiPolygon"
                    multipolygCount++;
                }
                ...
                if (geometryObj != null)
                {
                    if (geometryObj is Polygon polygon)
                    {
                        try
                        {
                            var (convertedPolygon, _) = CoordinatesConverter.ToUtm(polygon); // crash here. it doesn't consider buildings to be enclosed 
            ...
            Console.WriteLine(multipolygCount);
            return restrictions;
        }
    }
} 